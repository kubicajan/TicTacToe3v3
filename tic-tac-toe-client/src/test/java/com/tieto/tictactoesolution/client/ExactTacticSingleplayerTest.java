...
public class ExactTacticSingleplayerTest {
    ...
    public ExactTacticSingleplayerTest() {
    ...
    boolean firstRun = true, secondRun = false, thirdRun = false;
    ...
    private Optional<PlayerSymbol> playAgainstNpc(GameClient opponentGameClient) {
        ...
        do {
            ...
            if(!thirdRun && !secondRun && !firstRun)
            {
            ...
            {
                thirdRun = false;
                playerMove = new Point(2, 2);
                ConsoleUtil.printGameBoard(gameBoard, PlayerSymbol.O, playerMove, logger);
                gameBoard.setPlayerSign(playerMove.getRow(), playerMove.getColumn(), PlayerSymbol.O);
